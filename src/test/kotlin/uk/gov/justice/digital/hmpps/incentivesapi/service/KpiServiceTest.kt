...
class KpiServiceTest {
  ...
  inner class GetNumberOfReviewsConductedAndPrisonersReviewed {
    @Test
    fun `getNumberOfReviewsConductedAndPrisonersReviewed() returns the counts from the DB`(): Unit =
      runBlocking {
  ...
  inner class GetNumberOfPrisonersOverdue {
    ...
    @Test
    fun `getNumberOfPrisonersOverdue() returns the correct number of overdue prisoners`(): Unit =
      runBlocking {
