      ...
      val responseBytes = webTestClient.post().uri(syncCreateEndpoint)
        ...
        .expectBody().json(
          """
          {
            ...
            "iepTime":"${requestBody.iepTime.format(DateTimeFormatter.ISO_DATE_TIME)}",
      ...
      val expectedResponseBody = """
        {
           ...
           "iepTime":"${existingPrisonerIepLevel!!.reviewTime.format(DateTimeFormatter.ISO_DATE_TIME)}",
      ...
      val expectedResponseBody = """
        {
           ...
           "iepTime":"${updatedIepTime.format(DateTimeFormatter.ISO_DATE_TIME)}",
           "agencyId":"${existingPrisonerIepLevel!!.prisonId}",
           "locationId":"${existingPrisonerIepLevel!!.locationId}",
           "iepLevel":"Standard",
           "comments":"$updatedComment",
