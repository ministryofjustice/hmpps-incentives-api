...
class PrisonIncentiveLevelRepositoryTest : TestBase() {
  ...
  @Test
  fun `saves blank per-prison incentive level information`(): Unit =
    runBlocking {
      val entity =
  ...
  @Test
  fun `fails to save duplicate per-prison incentive level information`(): Unit =
    runBlocking {
      var entity =
        PrisonIncentiveLevel(
          levelCode = "STD",
  ...
  @Test
  fun `fails to save per-prison incentive level information for unknown levels`(): Unit =
    runBlocking {
      val entity =
        PrisonIncentiveLevel(
  ...
  @Test
  fun `fails to save per-prison incentive level information with invalid values`(): Unit =
    runBlocking {
      val entity =
        PrisonIncentiveLevel(
          levelCode = "STD",
  ...
  @Test
  fun `finds prison incentive levels in globally defined order`(): Unit =
    runBlocking {
  ...
  @Test
  fun `loads level description using join to global incentive levels`(): Unit =
    runBlocking {
      val entity =
        PrisonIncentiveLevel(
          levelCode = "ENH",
  ...
  @Test
  fun `loads default incentive level information in a prison`(): Unit =
    runBlocking {
      generateDefaultData()
  ...
  @Test
  fun `sets other levels to be non-default`(): Unit =
    runBlocking {
      generateDefaultData()
  ...
  @Test
  fun `find prisons that have active levels`(): Unit =
    runBlocking {
      generateDefaultData()
  ...
  @Test
  fun `find prisons that have specific level active`(): Unit =
    runBlocking {
      generateDefaultData()
