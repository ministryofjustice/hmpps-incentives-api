...
class NearestPrisonIncentiveLevelServiceTest {
  ...
  inner class `finding nearest levels` {
    ...
    @Test
    fun `when target level is available`(): Unit =
      runBlocking {
    ...
    @Test
    fun `when target level is not present, nor is there a higher one`(): Unit =
      runBlocking {
    ...
    @Test
    fun `when target and many other high levels are unavailable`(): Unit =
      runBlocking {
    ...
    @Test
    fun `when target level is not present, but there is a higher one higher`(): Unit =
      runBlocking {
    ...
    @Test
    fun `when target and many other low levels are unavailable`(): Unit =
      runBlocking {
    ...
    @Test
    fun `when target level is present but inactive`(): Unit =
      runBlocking {
    ...
    @Test
    fun `when target level is globally inactive`(): Unit =
      runBlocking {
    ...
    @Test
    fun `falls back to the prison's default when target is not found`(): Unit =
      runBlocking {
    ...
    @Test
    fun `fails when target is not found and there is no default`(): Unit =
      runBlocking {
    ...
    @Test
    fun `fails when target is not found and there is no default or standard`(): Unit =
      runBlocking {
    ...
    @Test
    fun `fails when a prison does not have any available levels`(): Unit =
      runBlocking {
