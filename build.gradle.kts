...
dependencies {
  ...
  runtimeOnly("com.ongres.scram:scram-client:3.4")
  runtimeOnly("org.springframework.boot:spring-boot-starter-jdbc")
  runtimeOnly("org.postgresql:postgresql:42.7.13")

  // Shedlock dependencies
  implementation("net.javacrumbs.shedlock:shedlock-spring:7.10.0")
  implementation("net.javacrumbs.shedlock:shedlock-provider-r2dbc:7.10.0")
  ...
  testImplementation("io.opentelemetry:opentelemetry-sdk-common:1.65.0")
