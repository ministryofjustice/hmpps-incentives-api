...
dependencies {
  ...
  testImplementation("io.opentelemetry:opentelemetry-sdk:1.54.0")
  testImplementation("io.opentelemetry:opentelemetry-sdk-common:1.54.0")
  testImplementation("io.opentelemetry:opentelemetry-sdk-metrics:1.54.0")
